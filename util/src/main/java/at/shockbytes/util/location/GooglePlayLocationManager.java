...
public class GooglePlayLocationManager implements LocationManager {
    ...
    private long fastestUpdateMillis;
    ...
    private LocationRequest createLocationRequest() {
        return new LocationRequest()
                .setInterval(updateMillis)
                .setFastestInterval(fastestUpdateMillis)
    ...
    @Override
    public void setUpdateInterval(long updateMillis) {

        if (updateMillis <= 1) {
            throw new IllegalArgumentException("Update millis must be > 1 ms");
        }
        this.updateMillis = updateMillis;
        this.fastestUpdateMillis = updateMillis / 2;
    }
